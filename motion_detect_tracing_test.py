...
if args.get("video",None) is None:
    ...
    time.sleep(0.25)
    #video fps setting --> 적용 안되는거같음 찾아봐야함
    camera.set(cv2.CAP_PROP_POS_FRAMES, 30)
else:
    #otherwise, reading from vido file
...
if camera.isOpened():    
    ...
    while ret:   
        ...
        #video recording save                     
        videoPath = 'test_videos/test_video.avi' 
        ...
        outVideo = cv2.VideoWriter(videoPath, fourcc, fps, (w,h))
        outVideo.write(draw)                    
